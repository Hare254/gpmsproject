  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"><span class="fa fa-home">The Cooperative University of Kenya GPMS</span></a>
      </div>
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          <li><a href="index.php" style="text-decoration: none;"><i class="icon-dashboard"></i><strong>GPMS</strong></a></li>
